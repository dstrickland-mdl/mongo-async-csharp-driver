...
{
    public class TakeWhileAsyncEnumerable<TSource> : IAsyncEnumerable<TSource>
    {
        // fields
        ...
        // constructors
        public TakeWhileAsyncEnumerable(IAsyncEnumerable<TSource> source, Func<TSource, bool> predicate)
        {
            _source = source;
            _predicate = (element, index) => predicate(element);
        }

        public TakeWhileAsyncEnumerable(IAsyncEnumerable<TSource> source, Func<TSource, int, bool> predicate)
        {
            _source = source;
